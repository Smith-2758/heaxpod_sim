...
cases = struct( ...
    'case_id', { ...
        ...
        'ditch_initial', 'ditch_half_mid', 'ditch_final_replay', 'ditch_final_closed_loop_off', 'ditch_final_closed_loop_on'}, ...
    'scene_name', { ...
        'slope', 'slope', 'step', 'step', ...
        'ditch', 'ditch', 'ditch', 'ditch', 'ditch'}, ...
    'scene_variant', { ...
        'current', 'baseline', 'current', 'initial', ...
        'initial', 'half_mid', 'final_replay', 'final_closed_loop_off', 'final_closed_loop_on'}, ...
    'description', { ...
        '当前斜坡方案', '斜坡旧版轨迹', '当前高台方案', '高台最初版（拆分自 origin 基线）', ...
        '深沟最初版（拆分自 origin 基线）', '深沟中间版（half）', '深沟最终版回放', '深沟最终版闭环（ZMP 关闭）', '深沟最终版闭环（ZMP 开启）'}, ...
    'source_type', { ...
        'pg_current', 'mat_file', 'pg_current', 'origin_step_initial', ...
        'origin_ditch_initial', 'ditch_half_generate_replay', 'mat_file', 'ditch_final_closed_loop', 'ditch_final_closed_loop'}, ...
    'pattern', { ...
    ...
    'script_path', { ...
        ...
        fullfile(root_external, 'MAIN', '6leg_motion', 'export_data', 'origin', 'walk3step.m'), fullfile(root_current, 'MAIN', '6leg_motion', 'ditch', 'CoppeliaSim_learn_ditch_half.m'), '', fullfile(root_current, 'MAIN', '6leg_motion', 'ditch', 'CoppeliaSim_learn_ditch.m'), fullfile(root_current, 'MAIN', '6leg_motion', 'ditch', 'CoppeliaSim_learn_ditch.m')}, ...
    'zmp_mode', { ...
        '', '', '', '', ...
        '', '', '', 'off', 'on'});
end
